@rijndael_fuzzing = (
    ...
    },
    {
        ...
        'fuzzing_pkt' =>
            ...
            'yEkDgP5+f49xrRA',
        'server_positive_output_matches' => [qr/Args\scontain\sinvalid\sdata/],
        'fwknopd_cmdline' => "$fwknopdCmd $srv_sdp_options -c $cf{'disable_aging_nat'} -a $cf{'legacy_iv_access'} " .
            "-d $default_digest_file -p $default_pid_file $intf_str",
    },

    {
        ...
        'cmdline' => "$fwknopdCmd $srv_sdp_options -c $cf{'disable_aging'} -a $cf{'fuzz_source'} " .
            "-d $default_digest_file -p $default_pid_file $intf_str",
    ...
    },
    {
        ...
        'function' => \&generic_exec,
        'cmdline' => "$fwknopdCmd $srv_sdp_options -c $cf{'disable_aging'} -a $cf{'fuzz_open_ports'} " .
            "-d $default_digest_file -p $default_pid_file $intf_str",
        'positive_output_matches' => [qr/Fatal\sinvalid/],
        'exec_err' => $YES,
    },
    {
        ...
        'function' => \&generic_exec,
        'cmdline' => "$fwknopdCmd $srv_sdp_options -c $cf{'disable_aging'} -a $cf{'fuzz_restrict_ports'} " .
            "-d $default_digest_file -p $default_pid_file $intf_str",
        'positive_output_matches' => [qr/Fatal\sinvalid/],
        'exec_err' => $YES,
    },
